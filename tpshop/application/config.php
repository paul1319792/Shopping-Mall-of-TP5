...
return [
    'auth'=>[
            'qqconnect' => [
                'appid' => '101554189',
                'appkey' => 'fef3dfc9b7efe1e3c69d90eb1c9ce3da',
                'callback' => 'http://www.tpshop.com/home/user/qqcallback',
                'scope' => 'get_user_info',
                'errorReport' => true
            ]
    ],
    ...
    'mail'=>[
            ...
            'host'            => 'smtp.sina.com', // 发件人的，邮件服务器地址
            'port'            => 465, // SMTP服务器端口号,一般为25
           // 'addr'            => 'hanhao803@sina.com', // 发件人邮箱地址
            'addr'            => 'liyanmei0608@sina.com', // 发件人邮箱地址
           // 'pass'            => 'flzxsqc123456', // 发件邮箱密码
            'pass'            => 'liyanmei0608', // 发件邮箱密码
            'name'            => '太阳系系主任', // 发件人邮箱名称（署名）
            ...
            'log_path'        => '../runtime/tp-mailer/', // 日志路径, 可选, 不配置日志驱动时启用默认日志驱动, 默认路径是 /path/to/tp-mailer/log, 要保证该目录有可写权限, 最好配置自己的日志路径
    ...
    // 应用调试模式 //为true开始调试模型，方便开发中调试工作，上线后要关闭。
    'app_debug'              => true,
    // 应用Trace
    'app_trace'              => false,
    // 应用模式状态
